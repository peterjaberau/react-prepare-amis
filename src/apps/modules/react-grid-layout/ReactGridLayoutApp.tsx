    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-800">React Grid Layout Dashboard</h1>
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              {isLoadFromMenuOpen && (
                <LoadFromMenu onSelect={handleLoadExample} onClose={() => setIsLoadFromMenuOpen(false)} />
              )}
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-10">
          {canvases.map(canvas => (
            <div key={canvas.id} className="bg-white shadow-md rounded-lg overflow-hidden">
              <CanvasHeader
                canvas={canvas}
