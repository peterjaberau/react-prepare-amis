...
import { config, getBackendSrv, FetchResponse } from '@runtime/index';
...
class K8sAPI implements DashboardSnapshotSrv {
  ...
  async getSharingOptions() {
    ...
    // we have http://localhost:3070/apis/dashboardsnapshot.grafana.app/v0alpha1/namespaces/default/options
