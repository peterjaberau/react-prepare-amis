...
import { variableAdapters } from '@grafana-module/app/features/variables/adapters';
import { onTimeRangeUpdated } from '@grafana-module/app/features/variables/state/actions';
import { GetVariables, getVariablesByKey } from '@grafana-module/app/features/variables/state/selectors';
import { CoreEvents, DashboardMeta } from '@grafana-module/app/types';
import { DashboardMetaChangedEvent, DashboardPanelsChangedEvent, RenderEvent } from '@grafana-module/app/types/events';
