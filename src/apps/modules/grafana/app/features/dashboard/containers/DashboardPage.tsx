...
import { GrafanaContext, GrafanaContextType } from '@grafana-module/app/core/context/GrafanaContext';
import { createErrorNotification } from '@grafana-module/app/core/copy/appNotification';
import { getKioskMode } from '@grafana-module/app/core/navigation/kiosk';
import { GrafanaRouteComponentProps } from '@grafana-module/app/core/navigation/types';
import { ID_PREFIX } from '@grafana-module/app/core/reducers/navBarTree';
...
import { AngularMigrationNotice } from '@grafana-module/app/features/plugins/angularDeprecation/AngularMigrationNotice';
