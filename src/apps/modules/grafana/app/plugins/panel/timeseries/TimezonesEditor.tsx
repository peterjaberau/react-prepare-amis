...
import { GrafanaTheme2, InternalTimeZones, StandardEditorProps } from '@data/index';
import { OptionsWithTimezones } from '@schema/index';
import { IconButton, TimeZonePicker, useStyles2 } from '@grafana-ui/index';
