    ...
    if (false) {
      subscriptions.add(
        eventBus.subscribe(DataHoverEvent, (event) => {
          ...
          if (time) {
            const lineTime: any = new Date(time);
            ...
            for (let l = 0; l < nightLinePoints.length - 1; l++) {
              const x1: number | any = Object.values(nightLinePoints[l])[0];
              const y1: number | any = Object.values(nightLinePoints[l])[1];
              const x2: number | any = Object.values(nightLinePoints[l + 1])[0];
              const y2: number | any = Object.values(nightLinePoints[l + 1])[1];
