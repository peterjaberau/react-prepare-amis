...
type Props = LokiQueryEditorProps & {
  annotation?: AnnotationQuery<LokiQuery | any>;
  onAnnotationChange?: (annotation: AnnotationQuery<LokiQuery | any>) => void;
};
...
export const LokiAnnotationsQueryEditor = memo(function LokiAnnotationQueryEditor(props: Props) {
  ...
  const onChangeQuery = (query: LokiQuery | any) => {
  ...
  const queryWithRefId: LokiQuery | any = {
    refId: '',
