...
import { QueryBuilderOperationParamEditorProps, VisualQueryModeller } from '@plugin-ui/index';
...
async function loadUnwrapOptions(
  ...
  datasource: LokiDatasource | any,
  queryModeller: VisualQueryModeller,
  timeRange = getDefaultTimeRange()
): Promise<Array<SelectableValue<string>>> {
  const queryExpr: any = queryModeller.renderQuery(query);
  const logExpr: any = getLogQueryFromMetricsQuery(queryExpr);
