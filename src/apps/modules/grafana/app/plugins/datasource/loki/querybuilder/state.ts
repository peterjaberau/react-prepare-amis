...
export function changeEditorMode(query: LokiQuery | any, editorMode: QueryEditorMode, onChange: (query: LokiQuery) => void) {
 ...
 */
export function getQueryWithDefaults(query: LokiQuery | any): LokiQuery {
