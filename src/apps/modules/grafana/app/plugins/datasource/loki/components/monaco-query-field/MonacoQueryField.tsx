...
import { useTheme2, ReactMonacoEditor, Monaco, monacoTypes, MonacoEditor } from '@grafana-ui/index';
    ...
    >
      <ReactMonacoEditor
        ...
        onMount={(editor, monaco) => {
          ...
          const isEditorFocused: any = editor.createContextKey<boolean>('isEditorFocused' + id, false) as any;
          // we setup on-blur
          ...
          (monaco.editor as any).addKeybindingRule({
