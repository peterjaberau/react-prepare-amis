...
import { DataSourcePluginOptionsEditorProps, SelectableValue } from '@data/index';
import { Box, DataSourceHttpSettings, InlineField, InlineSwitch, Select, Text } from '@grafana-ui/index';
