import { newId } from "@/apps/modules/gridstack/stories/app/utils.ts";
import { defaultGridOptions } from "@/apps/modules/gridstack/stories/app/default-grid-options.ts";
