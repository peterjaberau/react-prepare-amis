...
import { AdHocVariableFilter, DataSourceApi, GetTagResponse, MetricFindValue, SelectableValue } from '@data/index';
import { allActiveGroupByVariables } from './findActiveGroupByVariablesByUid';
import { DataSourceRef, VariableType } from '@schema/index';
...
import { InputActionMeta, MultiSelect, Select } from '@grafana-ui/index';
