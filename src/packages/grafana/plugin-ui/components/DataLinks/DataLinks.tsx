...
import { type GrafanaTheme2, VariableOrigin, DataLinkBuiltInVars } from '@data/index';
import { type DataLinkConfig } from './types';
import { DataLink } from './DataLink';


const getStyles = (theme: GrafanaTheme2 | any) => ({
  // @ts-ignore
  infoText: css`padding-bottom: ${theme.v1.spacing.md}; color: ${theme.v1.colors.textWeak};`,
  // @ts-ignore
  dataLink: css`margin-bottom: ${theme.v1.spacing.sm};`,
});
