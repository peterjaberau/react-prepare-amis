import { ScopedVars, DataSourceApi, DataSourceInstanceSettings, DataSourceRef } from '@data/index';
 ...
 * to the {@link @data/index#DataSourceApi | DataSourceApi} that have a rich API for
