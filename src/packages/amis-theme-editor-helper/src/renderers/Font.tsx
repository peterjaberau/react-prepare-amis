...
const SYSTEM_FONT_FAMILY = [
  ...
  {
    label: 'Bold-Simplified',
    value: 'Bold-Simplified'
  },
  {
    label: 'Bold-Traditional',
    value: 'Bold-Traditional'
  },
  {
    label: 'Helvetica',
    value: 'Helvetica'
  ...
  {
    label: 'Holly Black Simplified Chinese',
    value: 'Holly Black Simplified Chinese'
  },
  {
    label: 'Hoefler Text',
    value: 'Hoefler Text'
  ...
  {
    label: 'Ping Fang-Hong Kong',
    value: 'Ping Fang-Hong Kong'
  },
  {
    label: 'Ping Fang-Jian',
    value: 'Pingfang-Jian'
  },
  {
    label: 'Ping Fang-Traditional',
    value: 'Pingfang-Traditional'
  },
  {
  ...
  {
    label: 'Songti-Simplified',
    value: '宋体-简'
  },
  {
    label: 'Songti-Traditional',
    value: '宋体-繁'
  },
  {
    label: 'Chinese bold',
...
function FontEditor(props: FontEditorProps) {
  ...
  function handleEdit(value: string | undefined, type: keyof FontDataProps) {
    ...
    if (
      ...
      data[type] === value // These attributes are click events, so if you click for the second time, it means you want to cancel the current selection state
    ) {
      data[type] = undefined;
    } else {
      data[type] = value;
            ...
            {!hideColor && (
              <div className="Theme-FontEditor-item Theme-FontEditor-item-color-picker">
                <ColorPicker
                  ...
                  itemName="color"
                  state={state}
                  placeholder={editorDefaultValue?.color || 'font color'}
                />
              </div>
            )}
            {!hideFontSize && (
              <div className="Theme-FontEditor-item">
                <ThemeSelect
                  ...
                  menuTpl="label"
                  state={state}
                  placeholder={editorDefaultValue?.fontSize || 'font size'}
                />
              </div>
            )}
          </div>
            ...
            {!hideFontWeight && (
              <div className="Theme-FontEditor-item">
                <ThemeSelect
                  ...
                  menuTpl="label"
                  state={state}
                  placeholder={editorDefaultValue?.fontWeight || 'font weight'}
                />
            ...
            {!hideLineHeight && (
              <div className="Theme-FontEditor-item">
                <ThemeSelect
                  ...
                  state={state}
                  placeholder={
                    editorDefaultValue?.lineHeight || 'font line height'
                  }
                />
