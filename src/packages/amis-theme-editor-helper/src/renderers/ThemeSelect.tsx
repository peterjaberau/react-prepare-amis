 ...
 * @description A selectable and associative input box
 */
...
function ThemeSelectContent(props: ThemeSelectContentProps) {
  ...
  function getRealValue(value?: string) {
    ...
    return value === 'custom' ? 'Configure separately' : value;
  }
  ...
  const tooltipLabel = currentItem?.label || 'Configure separately';
        ...
        >
          ...
          >
            <div className="ThemeSelectContent-theme">
              {menuTpl ? (
                <div>
                  {(currentItem && (currentItem as any)[menuTpl]) ||
