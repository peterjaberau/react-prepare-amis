...
const component: ThemeDefinition['component'] = {
  ...
  pick: {
    ...
    status: {
      label: 'Configure different states',
      token: '--Pick-status-',
      body: {
        'hover-border': {
