...
export class ColorGenerator {
  ...
  setPrimaryColor(color: string) {
    if (this.reg.test(color)) {
      ...
      throw new Error('Please pass in the hexadecimal color value');
    }
  }
