...
export function renderChild(
  ...
  if (
    ...
    // Because the status is determined in SchemaRenderer
    // The renderer is also found there, so there is no way to wrap a component and send statusStore based on the renderer information before
    // So here we first process it according to type
    // Later, we will extract another level of state processing and put it in SchemaRenderer
    return (
      <StatusScopedWrapper>
        {({statusStore}) => (
          <Comp
