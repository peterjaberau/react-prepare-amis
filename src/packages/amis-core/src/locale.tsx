...
export function register(name: string, config: LocaleConfig) {
  //Change to extension to prevent registered corpus from being overwritten
...
export function format(str: string, data?: object) {
  if (!str.includes('{{')) return str; // Quickly check first to avoid unnecessary regular execution
