...
const ColSize: React.FC<FormControlProps> = props => {
  ...
  function handleColSizeChange(value: string) {
    ...
    if (length > 1) {
      if (value === '1') {
        // If set to occupy the entire row, you need to adjust the row of itself and the following elements
        ...
        // Not a whole row, you need to adjust the colSize of the same row elements
