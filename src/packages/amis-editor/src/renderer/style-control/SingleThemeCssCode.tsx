  ...
  if (!monaco.languages.getEncodedLanguageId('amisTheme')) {
    ...
    monaco.languages.registerCompletionItemProvider('amisTheme', {
      provideCompletionItems: (model: any, position: any) => {
        ...
        // Get the characters before input
        ...
        // If the key and value have already been configured, no suggestions will be given
        ...
        // Determine whether to prompt key or value
        if (!isEmpty(valueTip)) {
          suggestions = [
      ...
      >
        <PopOver overlay onHide={() => setShowPanel(false)}>
          <div className="ae-SingleThemeCssCode-panel">
            <div className="ae-SingleThemeCssCode-panel-title">Edit Style</div>
