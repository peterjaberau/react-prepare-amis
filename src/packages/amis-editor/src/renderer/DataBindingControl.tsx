...
// All content components must inherit this to be used as content selection panel
...
> {
  ...
  async handlePickerOpen() {
    ...
    try {
      ...
      this.setState({
        loading: false,
        hint: 'Failed to load available fields, please contact the administrator! '
      });
      return;
    }
    ...
    this.setState({
      loading: false,
      hint: schema ? undefined : 'No binding fields yet',
