...
import { DashboardModel, ScopeMeta } from '@grafana-module/app/features/dashboard/state/DashboardModel';
...
import { DashboardDTO, DashboardMeta, KioskMode, SaveDashboardResponseDTO } from '@grafana-module/app/types';
