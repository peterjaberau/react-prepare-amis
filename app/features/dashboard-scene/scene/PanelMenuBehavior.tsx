...
import { getCreateAlertInMenuAvailability } from '~/features/alerting/unified/utils/access-control';
...
import { getScenePanelLinksSupplier } from '~/features/panel/panellinks/linkSuppliers';
import { createExtensionSubMenu } from '~/features/plugins/extensions/utils';
import { addDataTrailPanelAction } from '~/features/trails/Integrations/dashboardIntegration';
