...
import { getCreateAlertInMenuAvailability } from '@grafana-module/app/features/alerting/unified/utils/access-control';
...
import { getScenePanelLinksSupplier } from '@grafana-module/app/features/panel/panellinks/linkSuppliers';
import { createExtensionSubMenu } from '@grafana-module/app/features/plugins/extensions/utils';
import { addDataTrailPanelAction } from '@grafana-module/app/features/trails/Integrations/dashboardIntegration';
