...
import { GrafanaTheme2, MappingType, StandardEditorProps, ValueMapping } from '@data/index';
import { useStyles2, VerticalGroup, Icon, ColorPicker, Button, Modal } from '@grafana-ui/index';
