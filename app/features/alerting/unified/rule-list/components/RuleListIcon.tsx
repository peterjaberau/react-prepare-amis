...
import { Icon, type IconName, Text, Tooltip } from '@grafana-ui/index';
import type { TextProps } from '@grafana-ui/components/Text/Text';
import type { RuleHealth } from '~/types/unified-alerting';
