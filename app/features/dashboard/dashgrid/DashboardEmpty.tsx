...
import { buildPanelEditScene } from '~/features/dashboard-scene/panel-edit/PanelEditor';
...
const DashboardEmpty = ({ dashboard, canCreate }: Props) => {
  ...
  return (
    <Stack alignItems="center" justifyContent="center">
      <Badge text={"DashboardEmpty"} color={"darkgrey"} style={{ position: 'absolute', top: 0, left: 0, zIndex:1000}}  />
