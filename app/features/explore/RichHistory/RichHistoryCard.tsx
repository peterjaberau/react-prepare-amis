...
import { TextArea, Button, IconButton, useStyles2 } from '@grafana-ui/index';
...
import { createUrlFromRichHistory, createQueryText } from '@grafana-module/app/core/utils/richHistory';
...
import { starHistoryItem, commentHistoryItem, deleteHistoryItem } from '@grafana-module/app/features/explore/state/history';
import { setQueries } from '@grafana-module/app/features/explore/state/query';
