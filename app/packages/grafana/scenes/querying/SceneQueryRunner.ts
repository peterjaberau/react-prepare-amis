...
import { DataQuery, DataSourceRef, LoadingState } from '@schema/index';
...
// @ts-ignore
import { getRunRequest, toDataQueryError, isExpressionReference, config } from '@runtime/index';
...
export class SceneQueryRunner extends SceneObjectBase<QueryRunnerState> implements SceneDataProvider {
  ...
  private prepareRequests(
    ...
    if (this._adhocFiltersVar) {
      ...
      // @ts-ignore (Temporary ignore until we update @data/index)
