...
export function VizPanelRenderer({ model }: SceneComponentProps<VizPanel>) {
  ...
  console.log('VizPanelRenderer.model', model);
  ...
  const alertStateStyles: any = useStyles2(getAlertStateStyles as any);
  ...
  const context: any = model.getPanelContext();
  const panelId: any = model.getLegacyPanelId();
