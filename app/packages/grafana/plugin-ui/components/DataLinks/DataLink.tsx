...
import { type VariableSuggestion, type DataSourceInstanceSettings, type DataSourceJsonData } from '@data/index';
import { Button, LegacyForms, DataLinkInput, stylesFactory } from '@grafana-ui/index';
