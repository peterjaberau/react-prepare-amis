...
import { FieldConfig as StateTimeLineFieldConfig } from '~/plugins/panel/state-timeline/panelcfg';
import { FieldConfig as StatusHistoryFieldConfig } from '~/plugins/panel/status-history/panelcfg';
