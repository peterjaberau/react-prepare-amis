...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@locker/near-membrane-dom/custom-devtools-formatter", replacement: path.resolve(__dirname, "node_modules/@locker/near-membrane-dom/dist") },
      { find: "react-loading-skeleton", replacement: path.resolve(__dirname, "node_modules/react-loading-skeleton/dist") },
      { find: "@grafana/ui", replacement: path.resolve(__dirname, "src/packages/grafana/grafana-ui") },
      { find: "@grafana/data", replacement: path.resolve(__dirname, "src/packages/grafana/data") },
